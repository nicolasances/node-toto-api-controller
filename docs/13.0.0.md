...
2. **Configure the Microservice basepath.** <br> 
...
*Note: you need to be on version 13+ of the `toto-api-controller` ([see docs here](https://github.com/nicolasances/node-toto-api-controller))
